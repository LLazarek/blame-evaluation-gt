...
#hash(("mutation" . #hash(("type-mistakes-in-code" . "mutation/mutate-benchmark.rkt")
      ...
      ("mutant-sampling" . #hash(("none" . "mutant-sampling/no-sampling.rkt")
                                 (("within-mutators"
                                   ; this path should be relative to `configurables`
                                   mutation-analysis-samples-db)
                                  .
                                  "mutant-sampling/sample-within-mutators.rkt")))
