...
sections: (i) the representativity of benchmarks; (ii) the relation between the
mutations and real programming mistakes; and (iii) the sampling strategy.
Although the experimental setup attempts to mitigate against these threats, the
reader must definitely keep these limitations in mind when drawing conclusions.
