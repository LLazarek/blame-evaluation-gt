...
performance issues of Natural~\citep{gtnffvf-jfp-2019}.  Fifth, the fact that both
...
detected~\cite{gfd-oopsla-2019}, and it is possible that blame has more or less
...
In fact, the authors have conducted a variation of the experiment that provides
some preliminary evidence that this difference may be significant. In
particular, the variation of the experiment includes only three of the
benchmarks but broadens the selection of scenarios to include any that raise
run-time errors under Natural, regardless of other semantics. The preliminary
results from this experiment suggest that without Erasure-bias, Natural blame
