...
An investigation of these empty blame cases reveals that Vitousek et al.'s
...
%% I don't see what this really means or contributes to the first two bullets:

 % \item The initial blame map must reflect the initial type environment.  For
 % instance, Typed Racket trusts that untyped core-library functions behave
 % correctly.
...
\end{enumerate}
Future work on Transient blame is needed to make an informed decision. The
evaluation process presented here can help guide this research. 
