...
%% While that detection disparity reflects reality in that such mistakes can be made in practice, it also biases the population to favor Natural in those new scenarios where Transient and Erasure have no chance to succeed.
