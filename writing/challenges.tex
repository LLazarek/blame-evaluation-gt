...
soundness mechanisms are available in a robust and comparable manner; for the
implementation of Transient Typed Racket, see the parallel submission of an
experience report~\cite{ttt21}.
