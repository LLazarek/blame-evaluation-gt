...
assignment systems. This paper contributes (1) the first evaluation
method for blame assignment systems and (2) the results from applying
it to three different systems. \mf{This sentence must be checked
...
\input{introduction.tex} \label{sec:introduction}
\input{landscape.tex}    \label{sec:landscape}
\input{challenges.tex}   \label{sec:challengs}
\input{ideas.tex}        \label{sec:ideas}
\input{experiment.tex}   \label{sec:experiment}
\input{results.tex}      \label{sec:results}
\input{discussion.tex}   \label{sec:discussion}
\input{related.tex}      \label{sec:related}
\input{conclusion.tex}   \label{sec:conclusion}
