...
%% \renewcommand{\shortauthors}{Lazarek, Greenman, Felleisen, Dimoulas}
...
%%% by Lukas Lazarek, Ben Greenman, Matthias Felleisen, and Christos Dimoulas.
%%%
\setcopyright{rightsretained}
\acmPrice{}
\acmDOI{10.1145/3473573}
\acmYear{2021}
\copyrightyear{2021}
\acmSubmissionID{icfp21main-p45-p}
\acmJournal{PACMPL}
\acmVolume{5}
\acmNumber{ICFP}
\acmArticle{68}
...
\keywords{gradual typing, blame}  %% \keywords are mandatory in final camera-ready submission
