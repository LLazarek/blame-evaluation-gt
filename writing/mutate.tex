...
portion of the program with the rest of the program.  In those cases, the rational programmer
...
least two distinct components, then this is accurate evidence of
interaction.  We require a third component because our benchmarks come
