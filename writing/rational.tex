...
for blame to useful in the context of a gradual type system for a specific
...
Putting the pieces together, we can now define when blame 
...
decide whether blame for natural more useful than blame for
