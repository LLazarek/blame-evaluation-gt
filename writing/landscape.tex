...
In essence, these checks protect typed modules when they call an untyped function
...
its arguments.  These checks protect functions exported from typed modules against
applications in untyped code that supply the wrong kind of arguments.
